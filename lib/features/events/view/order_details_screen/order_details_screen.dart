...
import '../ticket_booked_screen/ticket_booked_screen.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPaymentOption('Credit / Debit Card', AppIcon.mastercard),
            _buildPaymentOption('PayPal', AppIcon.paypal),
            _buildPaymentOption('Google Pay', AppIcon.googlepay),
